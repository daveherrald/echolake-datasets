...
The BOTSv1 dataset is released under the [CC0-1.0 (Creative Commons Zero)](https://creativecommons.org/publicdomain/zero/1.0/) license by Splunk, Inc. This places the data in the public domain, allowing unrestricted use, modification, and distribution.

- **Source repository:** [splunk/botsv1](https://github.com/splunk/botsv1)
