...
This dataset contains sample data for detecting when an email manually submitted to Microsoft through the Security & Compliance portal is found to be malicious. This capability is an enhanced protection feature that can be used within o365 tenants by administrative users to report potentially malicious emails. This correlation looks for any submission that returns a Phish or Malware verdict upon submission.
...
*Source: [Splunk Security Content](detections/cloud/o365_email_reported_by_admin_found_malicious.yml)*
