...
This dataset contains sample data for detecting the execution of native .NET binaries from non-standard directories within the Windows operating system.
