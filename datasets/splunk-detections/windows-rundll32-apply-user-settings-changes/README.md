...
This dataset contains sample data for detecting the execution of rundll32 with a call to the user32 DLL, specifically the UpdatePerUserSystemParameters function.
